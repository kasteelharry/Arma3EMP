...
list_man_emp = _poz_g nearEntities [["Civilian","SoldierGB","SoldierEB","SoldierWB"],_rang_emp]; //Returns all the units in the range, except the ones in vic (known bug, will be fixed soon)
